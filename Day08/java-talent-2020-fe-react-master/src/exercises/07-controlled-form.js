    ...
    render() {
        return <div>
            <form onSubmit={this.handleSubmit}>
                <label>Title: </label><input name="title" value={this.state.title} onChange={this.handleTitleChange}/>
                <p>{this.state.titleErrorMessage}</p>
                <label>Content: </label><input name="content" value={this.state.content}
